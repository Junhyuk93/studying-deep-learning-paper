...
## 네트워크 구축하기
# DCGAN
# https://arxiv.org/pdf/1511.063434.pdf
class DCGAN(nn.Module):
    def __init__(self, in_channels, out_channels, nker=64, norm='bnorm'):
        ...
        self.dec1 = DECBR2d(1 * in_channels, 8 * nker, Kernel_size=4, stride=1,
                            padding=0, norm=norm, relu=0.0, biase=False)
        ...
        self.dec5 = DECBR2d(1 * nker, out_channels, kernel_size=4, stride=2,
                            padding=1, norm=None, relu=None, bias=False) # tanh func 사용
...
class Discriminator(nn.Module):
    def __init__(self, in_channels, out_channels, nker=64, norm='bnorm'):
        ...
        self.enc5 = CBR2d(1 * nker, out_channels, kernel_size=4, stride=2,
